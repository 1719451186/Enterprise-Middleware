 ...
 */
public class BookingRepository {//FlightRepository
    ...
    public List<Booking> findByFlightId(Long FlightId) {
        TypedQuery<Booking> query = em.createNamedQuery(Booking.FIND_BY_FLIGHT, Booking.class).setParameter("findByFlightNo", FlightId);
        return query.getResultList();
    }
    ...
    public List<Booking> findByName(String name) {
        ...
        criteria.select(booking).where(cb.equal(booking.get("name"), name));
     ...
     */
    public Booking create(Booking booking) throws ConstraintViolationException, ValidationException {
        log.info("BookingRepository.create() - Creating " + booking.getFlight() + " " + booking.getCustomer() + " " + booking.getBookingDate());
    ...
    public Booking update(Booking booking){
        log.info("BookingRepository.update() - Updating " + booking.getFlight() + " " + booking.getCustomer() + " " + booking.getBookingDate());
    ...
    public Booking delete(Booking booking) throws Exception {
        log.info("BookingRepository.delete() - Deleting " + booking.getFlight() + " " + booking.getCustomer() + " " + booking.getBookingDate());
