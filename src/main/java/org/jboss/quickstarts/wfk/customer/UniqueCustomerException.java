 ...
 * @see Contact
 */
public class UniqueCustomerException extends ValidationException {
    ...
    public UniqueCustomerException(String message, Throwable cause) {
        super(message, cause);
    }

    public UniqueCustomerException(Throwable cause) {
        super(cause);
    }
}
