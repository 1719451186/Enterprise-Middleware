...
public class FlightServiceApplication extends Application {
    ...
    public FlightServiceApplication() {
        ...
        beanConfig.setTitle("JBoss Flights Swagger");
        ...
        beanConfig.setResourcePackage("org.jboss.quickstarts.wfk.customer,"
                + "org.jboss.quickstarts.wfk.flight,"+"org.jboss.quickstarts.wfk.booking,"
                +"org.jboss.quickstarts.wfk.guestBooking,"+"org.jboss.quickstarts.wfk.contact");
